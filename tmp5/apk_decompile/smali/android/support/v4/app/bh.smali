...
.method public final a(Landroid/support/v4/app/az;)Landroid/app/Notification;
    ...
    .prologue
    .line 569
    iget-object v0, p1, Landroid/support/v4/app/az;->a:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/az;->B:Landroid/app/Notification;

    iget-object v2, p1, Landroid/support/v4/app/az;->b:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/az;->c:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/az;->h:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/az;->f:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/az;->i:I

    iget-object v7, p1, Landroid/support/v4/app/az;->d:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/az;->e:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/az;->g:Landroid/graphics/Bitmap;
