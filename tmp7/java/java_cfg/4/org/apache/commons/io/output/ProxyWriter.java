...
public class ProxyWriter extends java.io.FilterWriter {
    ...
    public ProxyWriter(java.io.Writer p1)
    {
        super(p1);
        return;
    }
    ...
    public java.io.Writer append(CharSequence p3)
    {
    ...
    {
        try {
            this.beforeWrite((p4 - p3));
            this.out.append(p2, p3, p4);
            this.afterWrite((p4 - p3));
        } catch (java.io.IOException v0_3) {
            this.handleIOException(v0_3);
        }
        return this;
