...
public class AndFileFilter extends org.apache.commons.io.filefilter.AbstractFileFilter implements java.io.Serializable, org.apache.commons.io.filefilter.ConditionalFileFilter {
    ...
    public AndFileFilter(java.util.List p2)
    {
        if (p2 != null) {
    ...
    public AndFileFilter(org.apache.commons.io.filefilter.IOFileFilter p3, org.apache.commons.io.filefilter.IOFileFilter p4)
    {
        if ((p3 != null) && (p4 != null)) {
    ...
    public boolean accept(java.io.File p4)
    {
        int v0_1;
        if (!this.fileFilters.isEmpty()) {
            java.util.Iterator v2 = this.fileFilters.iterator();
            while (v2.hasNext()) {
                if (!((org.apache.commons.io.filefilter.IOFileFilter) v2.next()).accept(p4)) {
                    v0_1 = 0;
                }
            }
            v0_1 = 1;
    ...
    public boolean accept(java.io.File p4, String p5)
    {
        ...
        if (!this.fileFilters.isEmpty()) {
            java.util.Iterator v2 = this.fileFilters.iterator();
            while (v2.hasNext()) {
                if (!((org.apache.commons.io.filefilter.IOFileFilter) v2.next()).accept(p4, p5)) {
                    v0_1 = 0;
                }
            }
            v0_1 = 1;
