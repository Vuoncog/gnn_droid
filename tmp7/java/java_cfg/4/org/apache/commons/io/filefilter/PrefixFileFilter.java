...
public class PrefixFileFilter extends org.apache.commons.io.filefilter.AbstractFileFilter implements java.io.Serializable {
    ...
    public PrefixFileFilter(String p2)
    {
        this(p2, org.apache.commons.io.IOCase.SENSITIVE);
        return;
    }

    public PrefixFileFilter(String p3, org.apache.commons.io.IOCase p4)
    {
        if (p3 != null) {
    ...
    public PrefixFileFilter(java.util.List p2)
    {
        this(p2, org.apache.commons.io.IOCase.SENSITIVE);
        return;
    }

    public PrefixFileFilter(java.util.List p3, org.apache.commons.io.IOCase p4)
    {
        if (p3 != null) {
            String[] v0_3 = new String[p3.size()];
            this.prefixes = ((String[]) p3.toArray(v0_3));
            if (p4 == null) {
                p4 = org.apache.commons.io.IOCase.SENSITIVE;
            }
            this.caseSensitivity = p4;
    ...
    public PrefixFileFilter(String[] p4, org.apache.commons.io.IOCase p5)
    {
        if (p4 != null) {
            String[] v0_3 = new String[p4.length];
            this.prefixes = v0_3;
            System.arraycopy(p4, 0, this.prefixes, 0, p4.length);
            if (p5 == null) {
    ...
    public boolean accept(java.io.File p8)
    {
        ...
        String[] v3 = this.prefixes;
        int v1 = 0;
        while (v1 < v3.length) {
            if (!this.caseSensitivity.checkStartsWith(v2, v3[v1])) {
                v1++;
            } else {
                v0 = 1;
                break;
    ...
    {
        int v0 = 0;
        String[] v2 = this.prefixes;
        int v1 = 0;
        while (v1 < v2.length) {
            if (!this.caseSensitivity.checkStartsWith(p8, v2[v1])) {
                v1++;
            } else {
                v0 = 1;
                break;
    ...
    public String toString()
    {
        ...
        if (this.prefixes != null) {
            int v0_2 = 0;
            while (v0_2 < this.prefixes.length) {
                if (v0_2 > 0) {
                    v1_1.append(",");
                }
                v1_1.append(this.prefixes[v0_2]);
                v0_2++;
            }
        }
        v1_1.append(")");
