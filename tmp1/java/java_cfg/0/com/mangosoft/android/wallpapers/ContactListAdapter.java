...
public class ContactListAdapter extends android.widget.SimpleCursorAdapter {

    public ContactListAdapter(android.content.Context p1, int p2, android.database.Cursor p3, String[] p4, int[] p5)
    {
